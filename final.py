...
print("Select after theta join,Number of rows processed :%i\n"% (row_count))
row_count = 0
...
print("Cross join,Number of rows processed :%i\n"% (row_count))
row_count = 0
...
print("Select before theta join,Number of rows processed :%i\n"% (row_count))
row_count = 0
...
print("Natural join,Number of rows processed :%i\n"% (row_count))
row_count = 0
